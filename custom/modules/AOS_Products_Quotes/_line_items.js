...
function insertProductLine(tableid, groupid) {
    ...
    a5.innerHTML = "<input style='width:90px;' autocomplete='off' type='text' name='product_commission_c[" + prodln + "]' id='product_commission_c" + prodln + "' maxlength='50' value='' title='' tabindex='116' value=''>";	
...
function openProductPopup(ln){
	...
	var popupRequestData = {
		...
		"field_to_name_array" : {
			...
			"commission_rate_c" : "product_commission_rate" + ln,
