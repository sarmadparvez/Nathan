...
function display_lines_cstm($focus, $field, $value, $view){
    ...
    if($view == 'EditView'){
        ...
        while ($row = $focus->db->fetchByAssoc($result)) {
            ...
            if($line_item->product_id != '0' && $line_item->product_id != null){
                if($productCount == 0)
                {
					...
					$product .= "<td width='15%' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'>".$mod_strings['LBL_PRODUCT_NAME']."</td>";

          $product .= "<td width='10%' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'>".$mod_strings['LBL_PRODUCT_DESCRIPTION']."</td>";

					$product .= "<td width='5%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_GROSS_PREMIUM']."</td>";

					$product .= "<td width='5%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_VAT']."</td>";

					$product .= "<td width='5%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_VAT_AMT']."</td>";

					$product .= "<td width='5%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_TOTAL_PRICE']."</td>";



					$product .= "<td width='10%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_COMMISSION_RATE']."</td>";

					$product .= "<td width='10%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_COMMISSION']."</td>";

					$product .= "<td width='10%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_PAYABLE_PREMIUM']."</td>";
        ...
        $product .= "<td class='tabDetailViewDF' style='padding:2px;'>".$product_description."</td>";
                ...
                if($locale->getPrecision()){
                    $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:2px;'>".rtrim(rtrim(format_number($line_item->commission_rate_c), '0'),$sep[1])."%</td>";
                } else {
                    $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:2px;'>".format_number($line_item->commission_rate_c)."%</td>";
                }
                $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:2px;'>".currency_format_number($line_item->commission_c,$params )."</td>";

                $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:2px;'>".currency_format_number($line_item->payable_premium_c,$params )."</td>";
                ...
                if($serviceCount == 0)
                {
					...
					//colspan='2'
                    $service .= "<td width='20%' class='dataLabel' style='text-align: left;padding:2px;'  scope='row'>".$mod_strings['LBL_SERVICE_NAME']."</td>";

                    $service .= "<td width='12%' class='dataLabel' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_SERVICE_LIST_PRICE']."</td>";

                    $service .= "<td width='5%' class='dataLabel' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_VAT']."</td>";

                    $service .= "<td width='12%' class='dataLabel' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_VAT_AMT']."</td>";//LBL_SERVICE_TAX

                    $service .= "<td width='12%' class='dataLabel' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_SERVICE_PRICE']."</td>";

					$service .= "<td class='dataLabel' style='text-align: right;padding:2px;' scope='row'>&nbsp;</td>";
					$service .= "<td class='dataLabel' style='text-align: right;padding:2px;' scope='row'>&nbsp;</td>";
					$service .= "<td class='dataLabel' style='text-align: right;padding:2px;' scope='row'>&nbsp;</td>";
					$service .= "</tr>";
                }
...
function get_discount_string_cstm($type, $amount, $params, $locale, $sep){
...
function display_shipping_vat_cstm($focus, $field, $value, $view){
