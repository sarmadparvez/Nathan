...
<tr>
    <td width="100%">
        ...
        <tr>
            <td align="left" colspan='' class="dataLabel" width="20%"><b>{$MOD.LBL_CUSTOMER_INFO}<b>
            </td>
			<td></td>
         </tr>
         <tr>   
...
<tr>
    <td width="100%">
        ...
        <tr>
			<td align="left" class="dataLabel" width="20%"><b>{$MOD.LBL_ENTER_ACTIVATION_KEY}<b>
            </td>
			<td></td>
         </tr>
         <tr>   
         ...
         <tr>   
            ...
            <td><input type="textbox" size=30 name="serial_key" value="{$serial_key}" {$serial_mode} placeholder="Enter Activation Key"></td>
        </tr>
        <tr>
        <td></td>
		<td ><br>
