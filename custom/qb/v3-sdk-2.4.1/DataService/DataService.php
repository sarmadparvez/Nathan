...
class DataService {
    ...
    public function Update($entity) {
        ...
        try {
            ...
            //ross begin
			//throw new Exception('AvoidNullResponce:'.$e->getMessage());
			return array('error'=>true, 'error_msg'=>$e->getMessage());
            //ross end
        }
		//ross begin (SyncRestHandler need to be modified!)
		if($responseCode != '200'){
			throw new Exception('ErrorDetailed:'.$responseBody);
			return array('error'=>true, 'error_msg'=>$responseBody);
		}
		//ross end
    ...
    public function Add($entity) {       
        ...
        try {
            // gets response
            list($responseCode, $responseBody) = $dd = $restRequestHandler->GetResponse($requestParameters, $httpsPostBody, NULL);
        } catch (Exception $e) {
			//ross begin
			//throw new Exception('AvoidNullResponce:'.$e->getMessage());
			return array('error'=>true, 'error_msg'=>$e->getMessage());
