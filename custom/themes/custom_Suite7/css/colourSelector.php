...
input[type=submit],
input[type=reset],
.button, button, #create_link {
background: #<?php echo @$sugar_config['theme_settings']['Suite7']['button']; ?>; /* Old browsers */
...
input[type=reset]:hover, button:hover, #create_link:hover {
filter:none !important;
...
background: #<?php echo @$sugar_config['theme_settings']['Suite7']['suggestion_popup_from']; ?> 
 repeat scroll 0 0;
}
