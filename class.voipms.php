...
class VoIPms{
    ...
    \*******************************************/
    var $api_username   = 'support@gadgetplus.ca';
    var $api_password   = 'AffinityVoip1';
    ...
    function getSMS($from,$to,$type,$did,$contact,$limit,$timezone=""){
        $function = "getSMS";
        $params = array(
            "params" => array(
                "api_username"  => $this->api_username,
    ...
    function setSMS($did,$enable,$email_enabled,$email_address,$sms_forward_enable,$sms_forward,$url_callback_enable,$url_callback,$url_callback_retry){
        $function = "setSMS";
        $params = array(
            "params" => array(
                "api_username"        => $this->api_username,
