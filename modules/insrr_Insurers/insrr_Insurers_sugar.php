 ...
 * PLACE ANY CUSTOMIZATIONS IN insrr_Insurers
 */

require_once('include/SugarObjects/templates/company/Company.php');

class insrr_Insurers_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'insrr_Insurers';
	var $object_name = 'insrr_Insurers';
	var $table_name = 'insrr_insurers';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $is_mga;
		var $bond_commission;
		var $insurance_commision;
		function insrr_Insurers_sugar(){	
		parent::Company();
	}
