...
//	if(ACLController::checkAccess('AOR_Reports', 'list', true))$module_menu[]=Array("index.php?module=AOR_Reports&action=leadSummary", 'Report: Lead Summary', "AOR_Reports", 'AOR_Reports');
